...
async function startCapture(streamId) {
  ...
  try {
    ...
    nextStream = await navigator.mediaDevices.getUserMedia({
      ...
      // Leave enough room for either source orientation. Once the first raw
      // frame is available, matchingVideoReader selects the constraint order
      // that actually yields the client-derived visible dimensions on this
