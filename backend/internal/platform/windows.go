...
// The Windows platform resolves a real Chromium path
...
// processes running even with process.Kill's taskkill /T fix, because that fix
...
// forbids it) this logs and returns 0 — process.Kill's taskkill /T still
